...
class RestaurantTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        navigationController?.navigationItem.title = "Favourite Food Spot"
        ...
        if let customFont = UIFont(name: "Rubik-Medium", size: 35.0) {
            navigationController?.navigationBar.largeTitleTextAttributes = [ NSAttributedString.Key.foregroundColor: UIColor(red: 38, green: 162, blue: 78), NSAttributedString.Key.font: customFont]
        }
    }
